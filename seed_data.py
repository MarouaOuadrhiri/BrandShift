...
personal_tasks = [
    ...
    {"title": "Retouch 50 product photos",               "desc": "Batch retouch NovaSkin product images in Lightroom",   "status": "BLOCKED",        "user": 18},
    {"title": "Record voiceover for showreel",           "desc": "Agency showreel narration — 90s script",               "status": "BLOCKED",        "user": 20},
    {"title": "Research TikTok trends — beauty niche",   "desc": "Compile top 20 trending sounds and formats",           "status": "BLOCKED",        "user": 9},
    {"title": "Set up Google Analytics 4 for EcoWear",  "desc": "Install GA4 + configure e-commerce events",            "status": "BLOCKED",        "user": 17},
    ...
    {"title": "Source music for perfume reels",          "desc": "Find 3 royalty-free tracks from Artlist",               "status": "BLOCKED",        "user": 3},
    {"title": "Draft blog post: Ramadan marketing tips", "desc": "1200-word SEO article for agency blog",                 "status": "BLOCKED",        "user": 12},
